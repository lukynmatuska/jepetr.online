...
module.exports.send = (id, dataForEJS, callback) => {
  let localEjsData = ejsData
  localEjsData.data = dataForEJS
  this.read(id, (err, data) => {
    ...
    return transporter.sendMail({
      ...
      to: `"${dataForEJS.user.name.full}" <${dataForEJS.user.email}>`,
      subject: ejs.render(data.subject, localEjsData),
